...
import (
	...
	alteredAccount "github.com/ThotaGopichandThota/gn-core/data/alteredAccount"
	block "github.com/ThotaGopichandThota/gn-core/data/block"
	receipt "github.com/ThotaGopichandThota/gn-core/data/receipt"
	rewardTx "github.com/ThotaGopichandThota/gn-core/data/rewardTx"
...
type FeeInfo struct {
	...
	Fee            *math_big.Int `protobuf:"bytes,2,opt,name=Fee,proto3,casttypewith=math/big.Int;github.com/ThotaGopichandThota/gn-core/data.BigIntCaster" json:"fee,omitempty"`
	InitialPaidFee *math_big.Int `protobuf:"bytes,3,opt,name=InitialPaidFee,proto3,casttypewith=math/big.Int;github.com/ThotaGopichandThota/gn-core/data.BigIntCaster" json:"initialPaidFee,omitempty"`
}
...
var fileDescriptor_661b95cef868af95 = []byte{
	...
	,
}
